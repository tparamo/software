...
class Grid {
	...
	public:
		...
		bool isInsideCavity(int x, int y, int z, int element, int positions, bool tunnel);
		int getDimensions(int x_pos, int x_neg, int y_pos, int y_neg, int z_pos, int z_neg);
		int getDimensionsTunnel(int x_pos, int x_neg, int y_pos, int y_neg, int z_pos, int z_neg);
		bool doRefill(int x, int y, int z, int pos, int index);
